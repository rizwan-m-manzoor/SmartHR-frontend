export const authMsg = (subject: string, url: string) => {
  return `
    <div style="border: 5px solid #ccc; padding: 15px;">
      <h1 style="text-align: center;">Resource AI ${subject}</h1>
      ...
      <div style="margin-top: 20px;">
        <p>Thank you for using <strong>Resource AI</strong> as your job portal app.
        <p>Warm Regards,</p>
        <p>- Resource AI Team -</p>
      </div>
    </div>
  `
}
...
export const orgStatusMsg = (status: string) => {
  return `
    <div style="border: 5px solid #ccc; padding: 15px;">
      <h1 style="text-align: center;">Resource AI Organization Approval Status</h1>
      <p>${status === 'reject' ? 'We\'re sorry to inform you that your organization registration has been rejected by our admin. If you\'re sure that the information you provided is correct, please register your organization to Resource AI again, then our admin will kindly review it and accept it.' : 'Yay! Your organization registration status has been accepted by our admin. Post a job then select the best candidate to build a strong team at your organization :)'}</p>
      <div style="margin-top: 20px;">
        <p>Thank you for using <strong>Resource AI</strong> as your job portal app.
        <p>Warm Regards,</p>
        <p>- Resource AI Team -</p>
