  ...
  const handleSubmit = async (e: FormSubmit) => {
    ...
    if (!organizationData.phoneNumber) {
      return dispatch({
        type: "alert/alert",
        payload: {
          error: "Please provide organization phone number to register.",
        },
      });
    }
    ...
    if (description.length < 100) {
      return dispatch({
        type: "alert/alert",
        payload: {
          error: "Organization description should be at least 100 characters.",
        },
      });
    }
