        ...
        <>
          <div className="mb-8 mt-5 flex items-center justify-between">
            ...
            <button
              ...
              className="bg-blue-500 hover:bg-blue-600 transition-[background] text-white px-3 py-2 text-sm rounded-md"
            >
              Create Category
            </button>
          </div>
                          ...
                          >
                            ...
                            <td>
                              <button
                                ...
                                className="bg-orange-400 hover:bg-orange-500 transition-[background] rounded-md text-white px-2 py-1 text-xs"
                              >
                                Update
                              </button>
                              <button
                                onClick={() => handleClickDelete(item)}
                                className="bg-red-500 text-white hover:bg-red-600 transiiton-[background] rounded-md px-2 py-1 text-xs ml-5"
                              >
                                Delete
                              </button>
                            </td>
