            ...
            <button
              onClick={() =>
                dispatch({
                  ...
                  payload: info ? info : item?.jobseeker,
                })
              }
              className="bg-blue-500 hover:bg-blue-600 transition-[background] text-sm text-white rounded-md px-4 py-2"
            >
              Detail
            </button>
          )}
          ...
          {isApplicant ? (
            <>
              {item?.status !== "accepted" && item?.status !== "rejected" ? (
                ...
                <div
                  className={`${
                    item?.status === "accepted" ? "bg-green-600" : "bg-red-500"
                  } rounded-md capitalize text-white px-3 py-2 `}
                >
                  {item?.status}
                </div>
              )}
